...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : Int_Exp5_Pin Int_Exp6_Pin Int_Exp7_Pin Int_Exp8_Pin
                           Int_Exp1_Pin Int_Exp2_Pin Int_Exp3_Pin Int_Exp4_Pin */
  GPIO_InitStruct.Pin = Int_Exp5_Pin|Int_Exp6_Pin|Int_Exp7_Pin|Int_Exp8_Pin
                          |Int_Exp1_Pin|Int_Exp2_Pin|Int_Exp3_Pin|Int_Exp4_Pin;
